...
from optimization import optimization_restarts_parallel_TNC, optimization_restarts_parallel_CG, gaussian_optimization, optimization_restarts_parallel_LBFGS
...
def main():
    ...
    plot_prediction(x_u, t_u, x_f, t_f, u_train, f_train, x_star, t_star, mean_u, mean_f, title='Predictive mean and variance', save_path='heat_equation/plots/predictive_mean.png')
    plot_variance(x_u, t_u, x_f, t_f, u_train, f_train, x_star, t_star, var_u, var_f, title='Predictive mean and variance', save_path='heat_equation/plots/predictive_variance.png')
    ...
    plot_difference_analytical(x_u, t_u, x_f, t_f, u_train, f_train, x_star, t_star, mean_u_wolfram_grid, mean_f_wolfram_grid, u_grid, f_grid, title='Difference between analytical solution and predicted mean', save_path='heat_equation/plots/difference.png')
