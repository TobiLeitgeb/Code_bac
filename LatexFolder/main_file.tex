...
\begin{figure}[htbp!]
    ...
    \caption{(a) Relative $L^2$ errors dependent on the number of training points $n_{train}$ (b) Values of the hyperparameters $m,\gamma, k$ dependent on the number of training points $n_{train}$}
    ~\label{fig:damped_oscillator_with_noise}
\end{figure}
