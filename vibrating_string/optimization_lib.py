...
def gaussian_optimization(dictionary: dict, Kernel,restarts, X, Y, T, S, targets, noise):
    ...
    if best_result is None:
        ...
        best_result = gaussian_optimization(dictionary, Kernel,restarts, X, Y, T, S, targets, noise)
    print("------BO------")
